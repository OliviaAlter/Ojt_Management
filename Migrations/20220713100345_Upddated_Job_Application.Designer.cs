...
namespace OJTManagementAPI.Migrations
{
    ...
    [Migration("20220713100345_Upddated_Job_Application")]
    partial class Upddated_Job_Application
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OJTManagementAPI.Entities.JobApplicationStatus", b =>
                {
                    b.Property<int>("JobApplicationStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("JobApplicationStatusName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OJTManagementAPI.Entities.RecruitInfo", b =>
                {
                    b.Property<int>("RecruitInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OJTManagementAPI.Entities.JobApplication", b =>
                {
                    b.HasOne("OJTManagementAPI.Entities.JobApplicationStatus", "JobApplicationStatus")
                        .WithMany("JobApplications")
                        .HasForeignKey("JobApplicationStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OJTManagementAPI.Entities.RecruitInfo", "RecruitInfo")
                        .WithMany("JobApplications")
                        .HasForeignKey("RecruitInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
